...
public class ReturnController {
    ...
    public ResponseEntity<ApiResponse<String>> approveReturn(
        ...
        return ResponseEntity.ok(new ApiResponse<>(
            true, 
            "Return approved successfully. Customer refunded and inventory restocked."
        ));
    }

    @PatchMapping("/{returnId}/reject")
    public ResponseEntity<ApiResponse<String>> rejectReturn(
            @PathVariable Long returnId,
            HttpServletRequest request) {
