...
public class AdminController {
    ...
    public ResponseEntity<?> updateUserStatus(HttpServletRequest req, @PathVariable Long userId, @RequestParam String status) {
    	Long adminUserId=checkAndGetAdmin(req);
    ...
    public ResponseEntity<CouponResponse> updateCoupon(HttpServletRequest request, @PathVariable Long id, @RequestBody CouponRequest req) {
    	Long adminUserId=checkAndGetAdmin(request);
